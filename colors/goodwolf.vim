" COPIED FROM
" https://github.com/sjl/badwolf/blob/682b5215be013237f39be14954e6979426724a33/colors/goodwolf.vim
"
"                        _                 _  __
"                       | |               | |/ _|
...
" Normal text.
let s:bwc.plain          = ['#b9dffe', 15]
let s:bwc.background     = ['#111427', 232]
...
call GoodWolfHL('Normal', 'plain', 'background')
call GoodWolfHL('Folded', 'plain', 'background')
...
call GoodWolfHL('LineNr',     'deepergravel', 'bg', 'none')
call GoodWolfHL('SignColumn', 'deepergravel', 'bg', 'none')
call GoodWolfHL('FoldColumn', 'deepergravel', 'bg', 'none')
...
call GoodWolfHL('Comment',        'brightgravel', 'bg', 'none')
call GoodWolfHL('Todo',           'snow',   'bg', 'bold')
call GoodWolfHL('SpecialComment', 'snow',   'bg', 'bold')

" Strings are highlighted separately.
call GoodWolfHL('String', 'mediumgravel', '', 'bold')

" Turn off everything else
call GoodWolfHL('Boolean',      'plain', '', 'bold')
...
call GoodWolfHL('Keyword',      'plain', '', 'bold')
...
call GoodWolfHL('Type',         'plain', '', 'bold')
...
" }}}
" Go {{{
call GoodWolfHL('goComment', 'gravel', '', '')
call GoodWolfHL('goString', 'lime', '', '')
call GoodWolfHL('goStatement', 'plain', '', 'bold')
call GoodWolfHL('goBuiltins', 'plain', '', 'bold')
call GoodWolfHL('goConditional', 'plain', '', 'bold')
call GoodWolfHL('goDeclaration', 'plain', '', 'bold')
call GoodWolfHL('goDeclType', 'plain', '', 'bold')

" }}}
" vim-lsp {{{
call GoodWolfHL('lspReference', '', '', 'underline')
